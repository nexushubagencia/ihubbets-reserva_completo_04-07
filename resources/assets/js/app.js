...
Vue.component('financeiro-adm-gerente-component', require('./components/admin/FinanceiroAdmGerente.vue').default);

//Bilhetes Adm 
Vue.component('bilhete-adm-component', require('./components/admin/Bilhete.vue').default);
//Financeiro Adm Cambista 
Vue.component('financeiro-adm-cambista-component', require('./components/admin/FinanceiroAdmCambista.vue').default);
