                  ...
                  <div class="form-apostas-premium">
                    ...
                    <div class="info-ticket" style="margin-top: 10px; padding: 0 5px;">
                      ...
                      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                        ...
                        <div style="font-weight: 700; font-size: 16px; color: #222;">{{ retorno | formatMoeda() }}</div>
                      </div>
      ...
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content" style="background: var(--header--color, #000000); color: #fff; border: 1px solid var(--container_jogos--color);">
          ...
          <div class="modal-body text-center" style="padding: 20px;">
            ...
            <div v-else>
              <img v-if="image_share" :src="image_share" style="width: 100%; max-width: 400px; border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.5); background: #111;">
              ...
              <div class="share-actions" v-if="image_share" style="margin-top: 20px; display: flex; gap: 10px; justify-content: center; flex-wrap: wrap;">
                <button class="btn btn-info" @click="downloadBanner()">
                  <i class="fa fa-download"></i> Baixar Imagem
                </button>
...
export default {
  ...
  mounted() {
    ...
    // ═══ FIX DEFINITIVO DE MODAIS (AdminLTE Stacking Context Override) ═══
    // O AdminLTE aplica z-index:800 no .content-wrapper, criando um stacking
    // context que prende modais Bootstrap (position:fixed, z-index:1050).
    // SOLUÇÃO: Quando um modal abre, temporariamente removemos o z-index
    // do content-wrapper para liberar os modais. Ao fechar, restauramos.
    // Isso preserva os bindings do Vue (v-model, @click etc).
    $(document).on('show.bs.modal', '.modal', function () {
      // Logic handled via CSS body.modal-open
    });
  ...
  methods: {
    ...
    async openShareMatch(match, event) {
      ...
      try {
        ...
        const engine = new window.BannerEngine();
        const canvas = await engine.generateSingleGame(data, tpl);
