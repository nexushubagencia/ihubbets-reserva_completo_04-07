  ...
  <div class="wrapper">
          ...
          <div class="modal-body" style="padding: 0 30px 30px;">
            ...
            <div class="login-box-body" style="padding: 0; background: transparent;">
              ...
              <div style="margin-bottom: 20px;">
                <a href="password/reset" style="color: var(--container_jogos--color); font-size: 14px;">Esqueceu a senha?</a>
              </div>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      ...
                      <input tabindex="8" type="text" placeholder="E-mail" class="form-control" v-model="formRegister.email">
                    </div> 
                  </div>
                </div>
              </div>
    ...
    <input type="text" readonly :value="name" class="form-control">
                  ...
                  <div class="form-group" v-if="caixaUser">
                    <label>CPF:</label>
                    <input type="text" readonly :value="caixaUser.cpf" class="form-control">
                  </div>
                  <div class="form-group" v-if="caixaUser">
                    <label>Chave PIX:</label>
                    <input type="text" readonly :value="caixaUser.pix_key" class="form-control">
    ...
    <div class="modal fade" id="modal-caixa" v-if="logado">
    ...
    <div class="modal fade" id="modal-relatorio" v-if="logado">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button
    ...
    <div class="modal fade in" id="modal-pre-aposta" tabindex="-1" role="dialog" aria-hidden="true" style="z-index: 200000 !important;">
        ...
        <div class="row">
          <div class="col-md-9">
            ...
            <div v-if="jogosView">
                ...
                <div class="carousel-scroller-wrapper no-scrollbar" style="background: transparent !important; background-color: transparent !important; box-shadow: none !important; -webkit-box-shadow: none !important;" ref="carouselScroller" @mouseenter="stopAutoplay" @mouseleave="startAutoplay">
                  <div class="carousel-card" v-for="match in filteredFeaturedGames" :key="'featured-'+match.id">
                    ...
                    <div class="card-competitors">
                      ...
                      <button 
                        class="offer-badge" 
                        :class="{'theme-bg': !match.badge_color}"
                        :style="match.badge_color ? { backgroundColor: match.badge_color, border: 'none' } : {}"
              ...
              <ul class="menu-jogos" style="background: var(--sidebar--color) !important; overflow-x: auto; -webkit-overflow-scrolling: touch; white-space: nowrap;">
                <li class="modality-item-demo" v-if="op_futebol == 'Sim' || op_futebol == 'Ativado' || configuracoes.op_futebol == 'Sim' || configuracoes.op_futebol == 'Ativado'">
                  <a href="javascript:void(0)" @click="loadFutebol()" :class="{'ativo': futebol && !modalitySelected && !live}" style="color: var(--sidebar_text--color, #fff); text-decoration: none; display: flex; align-items: center; justify-content: center; padding: 10px 10px; font-size: 12px; font-weight: 500; text-transform: uppercase;">
                    <img src="/img/icons/football.png" style="width: 16px; height: 16px; margin-right: 5px;"> Futebol
                  </a>
                </li>
                <li class="modality-item-demo" v-if="op_ufcbox == 'Sim' || op_ufcbox == 'Ativado' || configuracoes.op_ufcbox == 'Sim' || configuracoes.op_ufcbox == 'Ativado'">
                  <a href="javascript:void(0)" @click="loadModality('Luta')" :class="{'ativo': modalitySelected == 'Luta'}" style="color: var(--sidebar_text--color, #fff); text-decoration: none; display: flex; align-items: center; justify-content: center; padding: 10px 10px; font-size: 12px; font-weight: 500; text-transform: uppercase;">
                    <img src="/img/icons/boxing.png" style="width: 16px; height: 16px; margin-right: 5px;"> Luta
                  </a>
                </li>
                <li class="modality-item-demo" v-if="op_basquete == 'Sim' || op_basquete == 'Ativado' || configuracoes.op_basquete == 'Sim' || configuracoes.op_basquete == 'Ativado'">
                  <a href="javascript:void(0)" @click="loadModality('Basquete')" :class="{'ativo': modalitySelected == 'Basquete'}" style="color: var(--sidebar_text--color, #fff); text-decoration: none; display: flex; align-items: center; justify-content: center; padding: 10px 10px; font-size: 12px; font-weight: 500; text-transform: uppercase;">
                    <img src="/img/icons/basketball.png" style="width: 16px; height: 16px; margin-right: 5px;"> Basquete
                  </a>
                </li>
                <li class="modality-item-demo" v-if="op_tenis == 'Sim' || op_tenis == 'Ativado' || configuracoes.op_tenis == 'Sim' || configuracoes.op_tenis == 'Ativado'">
                  <a href="javascript:void(0)" @click="loadModality('Tenis')" :class="{'ativo': modalitySelected == 'Tenis'}" style="color: var(--sidebar_text--color, #fff); text-decoration: none; display: flex; align-items: center; justify-content: center; padding: 10px 10px; font-size: 12px; font-weight: 500; text-transform: uppercase;">
                    <img src="/img/icons/tennis.png" style="width: 16px; height: 16px; margin-right: 5px;"> Tênis
                  </a>
                </li>
                <li class="modality-item-demo" style="border-right: none;" v-if="op_volei == 'Sim' || op_volei == 'Ativado' || configuracoes.op_volei == 'Sim' || configuracoes.op_volei == 'Ativado'">
                  <a href="javascript:void(0)" @click="loadModality('Volei')" :class="{'ativo': modalitySelected == 'Volei'}" style="color: var(--sidebar_text--color, #fff); text-decoration: none; display: flex; align-items: center; justify-content: center; padding: 10px 10px; font-size: 12px; font-weight: 500; text-transform: uppercase;">
                    <img src="/img/icons/volleyball.png" style="width: 16px; height: 16px; margin-right: 5px;"> Vôlei
                  </a>
                </li>
              </ul>
                ...
                <div class="jogo">
                  <div class="row container-lista-jogos" v-for="match in event.match" :key="match.id">
                      ...
                      <table style="width: 100%;">
                        <tr>
                          <td align="left" width="15%">
                            <img loading="lazy" width="35px" :src="match.logo_home || '/img/placeholders/shield.png'" :alt="match.home" @error="$event.target.src = '/img/placeholders/shield.png'">
                          </td>
                          <td align="center" width="30%">
                            {{ match.home }}
                          </td>
                          <td align="center" width="10%"><strong style="color: #777;">X</strong></td>
                          <td align="center" width="30%">
                            {{ match.away }}
                          </td>
                          <td align="right" width="15%">
                            <img loading="lazy" width="35px" :src="match.logo_away || '/img/placeholders/shield.png'" :alt="match.away" @error="$event.target.src = '/img/placeholders/shield.png'">
                          </td>
                        </tr>
                      </table>
                    </div>
                    ...
                    <div class="col-lg-1 col-md-1 col-xs-3 data-hora">
                      ...
                      <span v-else class="text-danger">{{ match.time }}' <i class="fa fa-circle pisca"></i></span>
                    </div>
              ...
              <div class="box box-widget overflow-hidden" style="margin-bottom: 65px; border-radius: 4px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                ...
                <div class="ticket-title-new box-header" style="background: var(--header--color, #000000) !important; padding: 10px 15px;">
                  ...
                  <div class="box-tools pull-right">
                    <a style="cursor: pointer; color: #fff; opacity: 0.8;" @click="removePalpites()">
                  ...
                  <div class="box-cupon-list" v-if="selection.length > 0" style="max-height: 400px; overflow-y: auto; margin-bottom: 15px; padding: 0 5px;">
                    <template v-for="(select, index) in selection">
                      ...
                      <div style="background-color: var(--card_header_bg--color, var(--container_jogos--color)); color: var(--card_header_text--color, #fff); padding: 5px 10px; font-size: 12px; font-weight: 600; display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <a @click="removePalpite(select.idOdd)" style="cursor: pointer; color: #fff; opacity: 0.8;"><i class="fa fa-trash"></i></a>
                      </div>
                      <div style="padding: 8px 10px;">
                        ...
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 2px;">
                          <span style="font-size: 13px; font-weight: 700; color: var(--container_jogos--color);">
                  ...
                  <div class="form-apostas-premium">
                    ...
                    <div class="info-ticket" style="margin-top: 10px; padding: 0 5px;">
                      ...
                      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 15px;">
                        ...
                        <div style="font-weight: 700; font-size: 16px; color: var(--container_jogos--color);">{{ retorno | formatMoeda() }}</div>
                      </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title"><i class="fa fa-user-plus"></i> Cadastro</h4>
          </div>
          <div class="modal-body box box-primary">
    ...
    <div class="modal fade" id="modal-validar-pin" style="z-index: 1070;">
      <div class="modal-dialog modal-sm">
    ...
    <div class="modal" id="modal-cupon" style="z-index: 100000 !important;">
        ...
        <div class="modal-content" style="background: var(--modal_bg--color, var(--background--color, #fff));">
          ...
          <div class="modal-body" style="padding: 10px; background: var(--modal_bg--color, var(--background--color, #fff));">
            ...
            <div style="display: flex; gap: 4px; margin-bottom: 10px; flex-wrap: wrap;">
              <button class="btn btn-info btn-sm flex-fill" @click="setValApostado(5)" style="flex: 1; font-weight: 700;">5,00</button>
              <button class="btn btn-info btn-sm flex-fill" @click="setValApostado(10)" style="flex: 1; font-weight: 700;">10,00</button>
              <button class="btn btn-info btn-sm flex-fill" @click="setValApostado(20)" style="flex: 1; font-weight: 700;">20,00</button>
              <button class="btn btn-info btn-sm flex-fill" @click="setValApostado(30)" style="flex: 1; font-weight: 700;">30,00</button>
              <button class="btn btn-info btn-sm flex-fill" @click="setValApostado(50)" style="flex: 1; font-weight: 700;">50,00</button>
            </div>
            ...
            <div style="display: flex; justify-content: space-between; margin-bottom: 10px; padding: 4px 0; border-top: 1px solid #eee; border-bottom: 1px solid #eee;">
              ...
              <span style="font-size: 13px; text-align: right;">
                Possível Retorno <br>
                <strong style="font-size: 18px; color: var(--container_jogos--color);">{{ retorno | formatCotacao() }}</strong>
              </span>
            </div>
            ...
            <button
              ...
              style="background-color: var(--container_jogos--color) !important; color: #fff; font-weight: 800; font-size: 16px; border-radius: 6px; margin-bottom: 12px;"
              @click="enviarAposta()"
              :disabled="loadingBtn"
            >
            ...
            <template v-for="(select, index) in selection">
              ...
              <div style="background: var(--card_header_bg--color, var(--container_jogos--color)); color: var(--card_header_text--color, #fff); padding: 5px 8px; border-radius: 3px; margin-bottom: 5px; display: flex; justify-content: space-between; align-items: center;">
                ...
                <span @click="removePalpite(select.idOdd)" style="cursor: pointer; color: #fff;">
                  <i class="fa fa-trash"></i>
                </span>
              </div>
              <div style="padding: 0 5px;">
                ...
                <div style="font-size: 13px;"><b>{{ select.group_opp }}</b></div>
                <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 4px;">
                  <span style="color: var(--container_jogos--color); font-weight: 700; font-size: 13px;">
                    <span v-if="select.type == 'ao-vivo'">{{ select.odd }} ({{ select.type }})</span>
                    <span v-else>{{ select.odd }}</span>
                  </span>
    ...
    <!-- MODAL SHARE BANNER -->
    <div class="modal fade" id="modal-share" tabindex="-1" role="dialog" style="z-index: 100001 !important;">
      <div class="modal-dialog modal-md" role="document">
        <div class="modal-content" style="background: var(--header--color, #000000); color: #fff; border: 1px solid var(--container_jogos--color);">
          <div class="modal-header" style="border-bottom: 1px solid #333;">
            ...
            <h4 class="modal-title"><i class="fa fa-picture-o"></i> Compartilhar Jogo</h4>
          </div>
          <div class="modal-body text-center" style="padding: 20px;">
            <div v-if="loading_share" style="padding: 40px;">
              <i class="fa fa-refresh fa-spin fa-3x" style="color: var(--container_jogos--color);"></i>
              <p style="margin-top: 15px; font-weight: 500;">Gerando banner personalizado...</p>
            </div>
            <div v-else>
              <img v-if="image_share" :src="image_share" class="img-responsive center-block" style="border-radius: 8px; box-shadow: 0 5px 15px rgba(0,0,0,0.5); max-height: 70vh;">
              ...
              <div class="share-actions" v-if="image_share" style="margin-top: 20px; display: flex; gap: 10px; justify-content: center;">
                <a :href="image_share" download="banner-jogo.png" class="btn btn-info">
                  <i class="fa fa-download"></i> Baixar Imagem
                </a>
                <button class="btn btn-success" @click="shareImageWhatsapp()">
    ...
    <!-- MODAL MAIS MERCADOS -->
    <div class="modal fade" id="modal-match" tabindex="-1" role="dialog" style="z-index: 100002 !important;">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content" style="background: var(--modal_bg--color, #f4f6f9); border-radius: 8px; overflow: hidden;">
          <div class="modal-header" style="background: var(--header--color, #000000); color: #fff; padding: 15px 20px; border: none;">
            <button type="button" class="close" data-dismiss="modal" style="color: #fff; opacity: 1;">&times;</button>
            <h4 class="modal-title" style="font-weight: 700; display: flex; align-items: center; gap: 10px;">
              <i class="fa fa-line-chart" style="color: var(--container_jogos--color);"></i> {{ match.league || liga }}
            </h4>
          </div>
          
          <div class="modal-body p-0">
            <!-- Banner do Jogo -->
            <div class="match-modal-banner" style="background: linear-gradient(135deg, var(--header--color, #000000) 0%, #2c3e50 100%); padding: 30px 20px; color: #fff; text-align: center;">
              <div class="row d-flex align-items-center justify-content-center">
                <div class="col-xs-5 text-right">
                  <h4 style="margin: 0; font-weight: 700; font-size: 18px;">{{ match.home }}</h4>
                  <img v-if="match.logo_home" :src="match.logo_home" style="width: 50px; height: 50px; margin-top: 10px; object-fit: contain;">
                </div>
                <div class="col-xs-2 text-center">
                  <div style="font-size: 24px; font-weight: 900; color: var(--container_jogos--color);">X</div>
                  <div style="font-size: 12px; margin-top: 5px; opacity: 0.8;">{{ match.date | formatDate() }}</div>
                </div>
                <div class="col-xs-5 text-left">
                  <h4 style="margin: 0; font-weight: 700; font-size: 18px;">{{ match.away }}</h4>
                  <img v-if="match.logo_away" :src="match.logo_away" style="width: 50px; height: 50px; margin-top: 10px; object-fit: contain;">
                </div>
              </div>
            </div>

            <!-- Lista de Mercados -->
            <div class="markets-container" style="padding: 15px; max-height: 60vh; overflow-y: auto;">
              <div v-if="loading_odds" style="padding: 40px; text-align: center;">
                <i class="fa fa-refresh fa-spin fa-3x" style="color: var(--container_jogos--color);"></i>
                <p style="margin-top: 15px; color: #666;">Carregando mercados...</p>
              </div>
              
              <div v-else>
                <div v-for="(mercado, mIndex) in mercados" :key="mIndex" class="mercado-group" style="margin-bottom: 15px; background: var(--container_jogos--color, #fff); border-radius: 6px; box-shadow: 0 2px 5px rgba(0,0,0,0.05);">
                  <div class="mercado-header" style="background: var(--card_header_bg--color, #f8f9fa); padding: 10px 15px; border-bottom: 1px solid var(--border--color, #eee); font-weight: 700; color: var(--card_header_text--color, #333); border-radius: 6px 6px 0 0;">
                    {{ translateLabel(mercado.name) }}
                  </div>
                  <div class="mercado-content" style="padding: 10px; display: grid; grid-template-columns: repeat(auto-fill, minmax(120px, 1fr)); gap: 8px;">
                    <div v-for="(odd, oIndex) in mercado.odds" :key="oIndex" 
                         class="odd-item" 
                         data-dismiss="modal"
                         @click="addPalpite(odd.uuid, odd.id, match.sport, match.id, odd.group_opp, odd.odd, odd.cotacao, liga, match.date, match.home, match.away, odd.type, odd.cotacaoOriginal, match.logo_home, match.logo_away)"
                         style="background: var(--container_jogos--color, #f1f4f7); padding: 10px; border-radius: 4px; cursor: pointer; transition: all 0.2s; display: flex; justify-content: space-between; align-items: center;"
                    >
                      <span style="font-size: 12px; color: #555;">{{ translateLabel(odd.odd) }}</span>
                      <strong style="color: var(--container_jogos--color);">{{ odd.cotacao | formatCotacao() }}</strong>
                    </div>
                  </div>
                </div>
              </div>
...
export default {
  ...
  mounted() {
    ...
    // ═══ SAFETY NET: Limpa backdrops órfãos quando qualquer modal fecha ═══
  ...
  methods: {
    ...
    showAlert(text, title = "Atenção", icon = "warning") {
      Swal.fire({
        ...
        confirmButtonColor: (getComputedStyle(document.documentElement).getPropertyValue('--container_jogos--color').trim() || '#1aa6d0'),
        didOpen: () => {
    ...
    loadServer() {
      if (this.site_info) {
        ...
        this.server.logo = this.site_info.complete_name || this.site_info.first_name;
    ...
    getWithdrawalHistory() {
      ...
      .catch((error) => {
        console.log("Erro ao buscar histórico de saques:", error);
      });
    },
    getBonusStatus() {
      axios.get("/api/bonus/my", {
    ...
    openShareMatch(match, event) {
      this.image_share = '';
      this.loading_share = true;
      $("#modal-share").modal("show");

      // Pegando as odds principais (1 X 2)
      let odds = "";
      if (match.odds && match.odds.length >= 3) {
        odds = match.odds[0].cotacao + " | " + match.odds[1].cotacao + " | " + match.odds[2].cotacao;
      }

      axios.post("/api/compartilha-imagem", {
        odds: odds,
        league: event.league,
        flag_home: match.logo_home,
        home: match.home,
        flag_away: match.logo_away,
        away: match.away,
        match_date: match.date,
        sport: match.sport || 'Futebol',
        theme: (getComputedStyle(document.documentElement).getPropertyValue('--container_jogos--color').trim() || '#1aa6d0') // Cor padrão do Nexus
      }).then((response) => {
        this.image_share = response.data;
      }).catch((error) => {
    ...
    shareImageWhatsapp() {
      ...
      let url = "https://api.whatsapp.com/send?text=" + encodeURIComponent(text + " " + this.image_share);
...
.offer-badge {
    background: var(--container_jogos--color); /* Dinâmico */
    color: #fff;
    border: none;
    border-radius: 20px;
    padding: 4px 12px;
