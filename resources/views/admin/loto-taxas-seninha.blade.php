...
@section('title', 'Taxas Seninha')

@section('content_header')
    <h1><i class="fas fa-star text-success"></i> Taxas Seninha</h1>
@stop

@section('content')
<div class="card card-success card-outline">
    <div class="card-header">
        <h3 class="card-title">Cotacoes por Numero (01-60)</h3>
    ...
    <div class="card-body table-responsive p-0">
        <table class="table table-hover table-striped">
            ...
            <tbody>
                ...
                <tr>
                    <td><span class="badge badge-success">{{ $taxa->dezena }}</span></td>
                    <td>
