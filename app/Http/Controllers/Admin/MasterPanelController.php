        ...
        return [
            'cores_gerais' => [
                ...
                'fields' => [
                    ...
                    ['field' => 'header_bg_color', 'label' => 'Cor do Cabeçalho Superior', 'hint' => 'Barra do topo onde fica o menu.', 'value' => $c('header_bg_color', $c('sidebar_color', '#173133'))],
            ...
            'sidebar' => [
                ...
                'fields' => [
                    ...
                    ['field' => 'sidebar_text_color', 'label' => 'Texto Sidebar', 'hint' => 'Cor dos links e ícones.', 'value' => $c('sidebar_text_color', '#ffffff')],
                    ...
                    ['field' => 'menu_hover_color', 'label' => 'Hover Menu (Fundo)', 'hint' => 'Cor ao passar o mouse.', 'value' => $c('menu_hover_color', '#33a26c')],
                    ...
                    ['field' => 'menu_item_active_bg_color', 'label' => 'Item Ativo (Fundo)', 'hint' => 'Destaque do item selecionado.', 'value' => $c('menu_item_active_bg_color', '#35aa71')],
            ...
            'jogos' => [
                'title' => '⚽ Listagem de Jogos e Odds',
                'icon' => 'fas fa-futbol',
                'description' => 'Tabelas de jogos, odds/cotações, e botão +3.',
                'fields' => [
                    ...
                    ['field' => 'odd_button_bg_color', 'label' => 'Fundo Cotação', 'hint' => 'Fundo padrão dos botões C/E/F.', 'value' => $c('odd_button_bg_color', '#ffffff')],
                    ['field' => 'odd_button_text_color', 'label' => 'Texto Cotação', 'hint' => 'Valor da odd dentro do botão.', 'value' => $c('odd_button_text_color', '#333333')],
                    ['field' => 'odd_button_hover_bg_color', 'label' => 'Hover Cotação (Fundo)', 'hint' => 'Mouse sobre a odd.', 'value' => $c('odd_button_hover_bg_color', '#35aa71')],
                    ['field' => 'odd_button_hover_text_color', 'label' => 'Hover Cotação (Texto)', 'hint' => 'Texto mouse over.', 'value' => $c('odd_button_hover_text_color', '#ffffff')],
                    ['field' => 'button_selected_color', 'label' => 'Cotação Selecionada', 'hint' => 'Cor quando a odd é ativada.', 'value' => $c('button_selected_color', '#0692bc')],
                    ['field' => 'button_selected_border_color', 'label' => 'Borda Cotação Ativa', 'hint' => 'Contorno da odd ativada.', 'value' => $c('button_selected_border_color', 'rgb(41, 118, 163)')],
                    ['field' => 'search_icon_bg_color', 'label' => 'Ícone Pesquisa (Lupa)', 'hint' => 'Cor de fundo da lupa.', 'value' => $c('search_icon_bg_color', '#35aa71')],
                    ['field' => 'odds_plus_button_color', 'label' => 'Botão +3 Mercados', 'hint' => 'Botão de mais mercados na lista.', 'value' => $c('odds_plus_button_color', '#1aa6d0')],
                    ['field' => 'share_button_bg_color', 'label' => 'Botão Compartilhar', 'hint' => 'Ícone da foto/banner no jogo.', 'value' => $c('share_button_bg_color', '#1aa6d0')],
                    ['field' => 'bet_main_buttons_color', 'label' => 'Botões C/E/F (Fundo)', 'hint' => 'Casa, Empate, Fora.', 'value' => $c('bet_main_buttons_color', '#1e262a')],
                    ['field' => 'modalidade_ativa_color', 'label' => 'Esporte Ativo', 'hint' => 'Aba FUTEBOL/BASQUETE selecionada.', 'value' => $c('modalidade_ativa_color', '#35aa71')],
                ],
            ],
            'destaque' => [
            ...
            'cupom' => [
                ...
                'fields' => [
                    ...
                    ['field' => 'cupom_apostar_btn_color', 'label' => 'Botão FINALIZAR APOSTA', 'hint' => 'Botão verde de concluir.', 'value' => $c('cupom_apostar_btn_color', '#35aa71')],
            ...
            'botoes_auth' => [
                'title' => '🔘 Botões Entrar / Cadastrar',
                'icon' => 'fas fa-sign-in-alt',
                'description' => 'Botões do canto superior direito do site.',
                'fields' => [
                    ...
                    ['field' => 'btn_primary_text_color', 'label' => 'Texto Botão Primário', 'hint' => 'Texto genérico em botões.', 'value' => $c('btn_primary_text_color', '#ffffff')],
