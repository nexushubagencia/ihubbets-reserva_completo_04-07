...
class LiveScore extends Command
{
    ...
    {
            //  while(1) {
                    $dados_live = Configuracao::where('site_id', config('tenant.site_id', 1))
                                            ->get();
                        ...
                        $bloqueadas = BlockLeague::where('site_id', config('tenant.site_id', 1))->get();
                        ...
                        $confs = Configuracao::where('site_id', config('tenant.site_id', 1))
                        ->get();
                        ...
                        $matchs = MatchModel::where( 'time_status', 1)
